...
namespace FG.CheckoutAndBuild2.Extensions
{
	...
	public static class ViewUtility
	{
		...
		/// <returns></returns>
		public static int ToDelphiColor(this System.Drawing.Color foreColor)
		{
			return System.Drawing.Color.FromArgb(0, foreColor.B, foreColor.G, foreColor.R).ToArgb();
		}
		...
		/// <returns></returns>
		public static System.Drawing.Color FromDelphiColor(int color)
		{
			var sysColor = System.Drawing.Color.FromArgb(color);
			// Rot und Blau mit Absicht wegen Delphi vertauscht
			return System.Drawing.Color.FromArgb(255, sysColor.B, sysColor.G, sysColor.R);
		}
		...
		/// Key ist der offset
		/// </summary>
		public static IEnumerable<KeyValuePair<double, System.Drawing.Color>> GetColors(this System.Windows.Media.Brush brush)
		{
		...
		/// </summary>
		public static System.Drawing.Color GetColor(this System.Windows.Media.Brush brush, bool lastOnGradient = false)
		{
		...
		/// eines LinearGradientBrushs zurück
		/// </summary>
		public static System.Drawing.Color GetColor(this System.Windows.Media.Brush brush, GradientColorOption option)
		{
			if (brush is SolidColorBrush)
		...
		/// <summary>
		/// Gibt an ob der aktuelle code gerade in der Suite läuft
		/// </summary>
		public static bool IsRunningInSuite
		{
			get { return (System.Windows.Application.Current != null && System.Windows.Application.Current.GetType().Name.EndsWith("SuiteApp")); }
		}
