...
namespace CheckoutAndBuild.Core.Contracts
{
	...
	public static class Operations
	{
		...
		public static OperationInfo Cancelling => new OperationInfo(2) { StatusText = "Cancelling", IsIndeterminate = true, ColorName = "Brown" };
		public static OperationInfo Queued => new OperationInfo(3) { StatusText = "Queued", IsIndeterminate = true, ColorName = "Orange" };
		...
		public static OperationInfo Starting => new OperationInfo(7) { StatusText = "Starting", IsIndeterminate = true, ColorName = "Azure" };
		public static OperationInfo Stopping => new OperationInfo(8) { StatusText = "Stopping", IsIndeterminate = true, ColorName = "Brown" };
		public static OperationInfo NugetRestore => new OperationInfo(9) { StatusText = "Nuget Restore", IsIndeterminate = true, ColorName = "Aquamarine" };
		public static OperationInfo Paused => new OperationInfo(10) { StatusText = "!! PAUSED !!", IsIndeterminate = false, Progress = 1, ColorName = "Orange" };
